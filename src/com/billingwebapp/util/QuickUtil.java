package com.billingwebapp.util;
...
import com.billingwebapp.domain.TblRunningId;
...
*/
	...
	/**
	 * for query on orderby in hibernate
	 * @param a
	 * @param tablename
	 * @param whereclause
	 * @return
	 */
	public static <T> List retrieveWherClauseOrderby(T a, String tablename,
			String whereclause) {
		Session session = HibernateUtils.currentSession();
		try {
			// Query query = session.createQuery("SELECT   "+columnames
	...
	public static String doGetNextPK(String strname) {
		 String whereclause="runningIdName='" + strname + "' ";
		List<TblRunningId> retrieveWherClause = retrieveWherClause(new TblRunningId(), "TblRunningId",whereclause);
		
		TblRunningId objempcat = new TblRunningId();
		
		objempcat= retrieveWherClause.get(0);
		
		objempcat.setRunningIdNumber(objempcat.getRunningIdNumber() + 1);
		
		QuickUtil.updateToOld(objempcat);
		
		return "" +  objempcat.getRunningIdString() + objempcat.getRunningIdNumber() +""; 
		
	}
	
//	public static String getCurrentYear() {
//		
////		List<TblAcyearMaster> retrieveWherClause = retrieveWherClause(new TblAcyearMaster(), "TblAcyearMaster", "acyearCurrentyear='Yes'");
//		
//		TblAcyearMaster objempcat = new TblAcyearMaster();
//		
//		objempcat= retrieveWherClause.get(0);
//		
//		return objempcat.getAcyearId();
//		
//		
//	}
	
//	public static String doGetNextPKBill(String strname) {
//		
//		List<TblRunningidMaster> retrieveWherClause = retrieveWherClause(new TblRunningidMaster(), "TblRunningidMaster", "run_Name='" + strname + "' and runYear='" + getCurrentYear() + "'");
//		
...
//		QuickUtil.updateToOld(objempcat);
//		
//		return  objempcat.getRunNos().toString() +"/" +  objempcat.getRunPreappend() + "/" +  objempcat.getRunYear()  ; 
//		
//	}
